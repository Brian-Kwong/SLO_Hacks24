...
export async function submitFood(req, res){
    ...
    const foodFacts = await fetch(`https://mealathon.azurewebsites.net/foodFacts?foodName=${imgData ? imgData.dish : foodName}`, {method: "GET"}).then((response) => {return response.json()});
